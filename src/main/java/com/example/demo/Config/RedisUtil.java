...
public class RedisUtil {
	...
	public Map<String,String> getMap(String key){
		...
		try{
			...
			/*result.put("yh_dm",list.get(0));
			result.put("js_dm",list.get(1));
			result.put("zzdw_dm",list.get(2));
			result.put("bm_dm",list.get(3));*/
		}catch (Exception e ){
			e.printStackTrace();
		}finally {
			jedisPool.returnResource(jedis);
